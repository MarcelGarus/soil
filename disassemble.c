...
void dump_binary(void) {
  ...
  while (cursor < byte_code_len) {
    ...
    switch (EAT_BYTE) {
      ...
      case 0xc7: sprintf(cmd, "isequal"); break;
      case 0xc8: sprintf(cmd, "isless"); break;
      case 0xc9: sprintf(cmd, "isgreater"); break;
      case 0xca: sprintf(cmd, "islessequal"); break;
      case 0xcb: sprintf(cmd, "isgreaterequal"); break;
      case 0xcc: sprintf(cmd, "isnotequal"); break;
      case 0xcd: EAT_REGS; sprintf(cmd, "inttofloat %s", reg1); break;
      case 0xce: EAT_REGS; sprintf(cmd, "floattoint %s", reg1); break;
