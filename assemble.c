...
void main(int argc, char** argv) {
  ...
  while (true) {
    ...
    if (is_label) {
      ...
      else if (strequal(command, str("fisequal"))) EMIT_OP(0xc7)
      else if (strequal(command, str("fisless"))) EMIT_OP(0xc8)
      else if (strequal(command, str("fisgreater"))) EMIT_OP(0xc9)
      else if (strequal(command, str("fislessequal"))) EMIT_OP(0xca)
      else if (strequal(command, str("fisgreaterequal"))) EMIT_OP(0xcb)
      else if (strequal(command, str("fisnotequal"))) EMIT_OP(0xcc)
      else if (strequal(command, str("inttofloat"))) EMIT_OP_REG(0xcd)
      else if (strequal(command, str("floattoint"))) EMIT_OP_REG(0xce)
